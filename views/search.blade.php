        ...
        <div class="col-sm-4">
            <div class="trending-wrapper">
                ...
                <div class="container searched-item">
                        <img class="trending-image" src="/images/{{ $item->image }}" height="500" width="500">
                        <br><div class="">
                            ...
                            <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data" class="flex justify-end">
                                ...
                                <div style="width:100%;text-align:center;"> <button class=" px-4 py-1.5 text-white text-sm bg-pink-700 rounded">Add To Cart</button> </div>
                            </form>
